---
title: "BHPS ownershpip transition probabilities"
...
Get BHPS data and aggrgegate data. Clean data and merge in aggregate data at quarterly freqency. 
...
Check aggregate first stage IV of interest rate on GDP and that underying data correlates well with GDP 
...
Now run regressions of changes in individual tenure status at 12 and 24 months horizon conditional on current status and monetary policy shock in quarter of interview
...
Probability of owning home after 12 months     
```{r}
    print(coef.h1.own)

```

Probility of owning home after 24 months 
```{r}
    print(coef.h2.own)
```

Figures of transition probability by age and income
